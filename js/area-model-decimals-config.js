 ...
 * please modify area-model-decimals/package.json to control dependencies.
 *
 * RequireJS configuration file for the area-model-decimals sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'area-model-decimals-main' ],
