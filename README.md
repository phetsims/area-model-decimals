Area Model Decimals
=============
"Area Model Decimals" is an educational simulation in HTML5, by <a href="https://phet.colorado.edu/" target="_blank">PhET
...
<a href="https://phet.colorado.edu/sims/html/area-model-decimals/latest/area-model-decimals_en.html" target="_blank">Click here to
run "Area Model Decimals".</a>
...
(5) Open in the browser: `http://localhost/area-model-decimals/area-model-decimals_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/area-model-decimals/build/adapted-from-phet/area-model-decimals_en_adapted-from-phet.html` (You will
